...
<link href="/R03TeamB/css_js/A02/entry-in-style.css" rel="stylesheet"
	type="text/css">
	...
	<div class="container mt-5 pt-5">
		...
		<form action="EntrySave" method="post">
						...
						<td>
							<div class="mb-3">
								<select class="form-select" name="dormitory" id="exampleFormSelect1">
									...
									<option value="R2">ドミトリー仙台一番町</option>
									<option value="R3">北山寮</option>
									<option value="R4">清水沼寮</option>
								</select>
							</div>
						</td>
					</tr>
			...
			<table class="table table-bordered" id="table_calc">
				...
				<tr class="right">
					<td class="left"><input type="hidden" name="certList" value="在寮証明書">在籍期間証明書</td>
					<td><input type="hidden" name="priceList" value="200">200円</td>
